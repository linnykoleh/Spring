...
public class JdbcNamedTemplateUserRepo implements UserRepo {
	...
	public int deleteById(Long userId) {
		...
		final HashMap<String, Object> id = new HashMap<String, Object>() {{
			put("id", userId);
		}};
		return jdbcNamedTemplate.update(query,
				id
		);
	}
	...
	public int updatePassword(Long userId, String newPass) {
		final String sql = "update p_user set password= :pass where ID = :id";
	...
	public int updateUsername(Long userId, String username) {
		final String sql = "update p_user set username=:un where ID = :id";
	...
	public String findUsernameById(Long id) {
		final String sql = "select email from p_user where ID = :id";
